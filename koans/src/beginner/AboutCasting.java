...
public class AboutCasting {
    ...
    public void downcastWithInheritance() {
        ...
        Parent parentReference = (Parent) child; // Why do we need an explicit cast here? (Cast from Grandparent -> Parent)
        Child childReference = (Child) parentReference; // Or here? (Cast from Parent -> Child)
