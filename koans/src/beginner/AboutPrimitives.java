...
public class AboutPrimitives {
    ...
    public void integersHaveAFairlyLargeRange() {
        ...
        assertEquals(Integer.MAX_VALUE, (int) (Math.pow(2,31) - 1));
    }
    ...
    public void longsHaveALargerRangeThanInts() {
        ...
        assertEquals(Long.MAX_VALUE, (long)(Math.pow(2, 63) - 1));
    }
    ...
    public void doublesHaveALargeRange() {
        ...
        assertEquals(Double.MAX_VALUE, (double) 0x1.fffffffffffffP+1023);
    }
