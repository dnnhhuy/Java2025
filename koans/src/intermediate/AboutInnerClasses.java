...
public class AboutInnerClasses {
    ...
    public void creatingAnonymousInnerClassesToImplementInterface() {
        ...
        // an object of that type? -> Create a class that implemented this interface and an object of that type
    }
    ...
    public void innerClassAndInheritanceOther() {
        ...
        // Compare this result with the last koan. What does that mean? This class inherited from AboutInnerClasses
    ...
    public void staticInnerClass() {
        ...
        // What happens if you try to access 'x' or 'theAnswer' from the outer class? Cannot access
        // What does this mean for static inner classes? static attached to class instead of instance
